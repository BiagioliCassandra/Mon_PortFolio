...
<section>
    ...
    <div class="text-center btn-group d-block mx-auto" role="group" aria-label="Basic example">
        <a class="btn text-white color_containerLight" href="adminProjectForm.php">Ajouter un projet</a>
    ...
    <div class="margin_2em list-group">
        <header class="d-flex w-100 justify-content-between align-items-center">
            ...
            <div>
                <a class="puce color_text" href="adminProjectForm.php?id=<?php echo$project['id'] ?>&action=update"><i class="fas fa-edit fa-2x"></i><a>
                <a class="puce color_text" href="adminProjectTreatment.php?id=<?php echo$project['id']; ?>&action=remove"><i class="fas fa-times fa-2x"></i></a>
            <div>
        </header>
